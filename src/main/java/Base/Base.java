...
public class Base {
	...
	public void driverSetup() {
		...
		driver.manage().timeouts().pageLoadTimeout(70, TimeUnit.SECONDS); // Waiting time to page the load completely
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS); // Adding driver waits to timeouts
	...
	public void openUrl() throws InterruptedException // Method to open URL for smoke test
	{
